...
plt.tight_layout()
# plt.savefig('../output/errors_VG_Sshape.png')
plt.show()
...
plt.tight_layout()
# plt.savefig('../output/errors_LD_Sshape.png')
plt.show()
...
plt.tight_layout()
# plt.savefig('../output/images_Sshape.png')
plt.show()
...
plt.legend()
# plt.savefig('../output/plot_PCA_Sshaped.png')
plt.show()
...
plt.imshow(radon(xs_em_refined[-1], candidate_angles, circle=True, preserve_range=True))
plt.show()
